...
export const WithLoadingState: Story = {
  ...
  render: (props) => <ChatInput {...props} />,
  parameters: {
    docs: {
      description: {
        story: 'Illustrates the loading state of the ChatInput component. The input field and send button are disabled, and a loading indicator is displayed.',
      },
    },
  },
};
...
export const ComponentStates: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Illustrates various visual states of the ChatInput component, including standard, multi-agent, and loading states.',
      },
    },
  },
}; 